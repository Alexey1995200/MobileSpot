...
// @grant        none
// @downloadURL https://raw.githubusercontent.com/Alexey1995200/MobileSpot/refs/heads/main/script.js
// @updateURL https://raw.githubusercontent.com/Alexey1995200/MobileSpot/refs/heads/main/script.js
// ==/UserScript==
// orig https://update.greasyfork.org/scripts/558091/Spotify%20Mobile%20%2B%20AdBlocker%20%2B%20Mute.meta.js
...
[data-testid="cover-art-button"] [data-testid="cover-art-image"]{
...
`;
  ...
  function addFullscreenButton(){
    ...
    if(document.getElementById("np-fullscreen-btn")) return;

    const btn = document.createElement("button");
    btn.id = "np-fullscreen-btn";
    btn.innerHTML = "⛶";
    ...
    btn.onclick = () => {
      ...
      bar.classList.toggle("nowPlayingFull");
  ...
  setInterval(addFullscreenButton,1000);
